...
// Bebidas
var orujo = new Objeto("Orujo", 0);
var whisky = new Objeto("Whisky", 50);
var ron = new Objeto("Ron", 50);
var vino = new Objeto("Vino", 50);

// Cosas personales
var bandera1 = new Objeto("Bandera1", 50);
var bandera2 = new Objeto("Bandera2", 50);
var pelucheViejo = new Objeto("Peluche Viejo", 50);
var pelucheNuevo = new Objeto("Peluche Nuevo", 50);

// Cartas 
var cartaSello = new Objeto("Carta Sello", 50);
...
var collarPerlas = new Objeto("Collar de Perlas", 50);
var collarOro = new Objeto("Collar de Oro", 50);
